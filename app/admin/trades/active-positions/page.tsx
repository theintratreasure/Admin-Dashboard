...
const ALL_COLUMNS: Column[] = [
  ...
  { key: "activeBuy", label: "Active Buy" },
  { key: "activeSell", label: "Active Sell" },
...
<div className="relative w-full sm:w-auto">
  ...
  {showDropdown && (
    <div
      className="
        absolute top-full left-0 sm:right-0 sm:left-auto
        mt-2 w-[90vw] sm:w-48
        bg-[var(--card-bg)]
    ...
    >
      ...
      {ALL_COLUMNS.map((col) => (
        <label
          key={col.key}
          className="flex items-center gap-2 cursor-pointer text-sm py-1 hover:text-[var(--primary)] transition"
        >
          <input
            type="checkbox"
